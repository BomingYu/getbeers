          ...
          >
            {menuOpen ? (
              <li className="lg:hidden">
                <button
                  onClick={toggleMenu}
                  className="text-black dark:text-gray-600 m-3 p-2 focus:outline-none text-lg font-bold border-4 border-black dark:border-white rounded-lg"
                >
                  Close
                </button>
              </li>
            ...
            <li>
              <Link href="/beers/ale" className="text-black dark:text-gray-700 font-bold hover:underline hover:text-gray-600 dark:hover:text-black">Ale Beers</Link>
            </li>
            <li>
              <Link href="/beers/stouts" className="text-black dark:text-gray-700 font-bold hover:underline hover:text-gray-600 dark:hover:text-black">Stouts Beers</Link>
            </li>
          </ul>
        </div>
      </div>
